...
A repository intended for open source software for bioinformatics.

Installing a package that is in Bioconductor is also simple! However, it is very dependent on the your version of R.

```{r}
  sessionInfo() # a useful command to know your R version and 
```
